...
public class Gen4RomHandler extends AbstractDSRomHandler {
        ...
        while (m.find()) {
            ...
            switch (segments[0]) {
                ...
                case "Forme":
                    ...
                    break;
                case "Event":
                    // Parse Event=[file:offset] format
                    String[] eventParts = offsets[0].trim().split(":");
                    sp.eventFile = parseRIInt(eventParts[0]);
                    sp.eventEntryIDOffset = parseRIInt(eventParts[1]);
                    break;
            }
        }
        return sp;
    ...
    private static class StaticPokemon {
        ...
        // Added for event files that need it
        protected int eventFile = -1;
        protected int eventEntryIDOffset = -1;
    ...
    private int getPokemonOverworldEntryID(int speciesNumber) {
        // Huge list of Entry IDs for each Pokemon matched with their pokedex number
        Map<Integer, Integer> speciesToEntryID = new HashMap<>();
        speciesToEntryID.put(1, 428);
        speciesToEntryID.put(2, 429); 
        speciesToEntryID.put(3, 430); 
        speciesToEntryID.put(4, 432); 
        speciesToEntryID.put(5, 433); 
        speciesToEntryID.put(6, 434); 
        speciesToEntryID.put(7, 435); 
        speciesToEntryID.put(8, 436); 
        speciesToEntryID.put(9, 437); 
        speciesToEntryID.put(10, 438);
        speciesToEntryID.put(11, 439);
        speciesToEntryID.put(12, 440);
        speciesToEntryID.put(13, 441);
        speciesToEntryID.put(14, 442);
        speciesToEntryID.put(15, 443);
        speciesToEntryID.put(16, 444);
        speciesToEntryID.put(17, 445);
        speciesToEntryID.put(18, 446);
        speciesToEntryID.put(19, 447);
        speciesToEntryID.put(20, 448);
        speciesToEntryID.put(21, 449);
        speciesToEntryID.put(22, 450);
        speciesToEntryID.put(23, 451);
        speciesToEntryID.put(24, 452);
        speciesToEntryID.put(25, 453);
        speciesToEntryID.put(26, 455);
        speciesToEntryID.put(27, 456);
        speciesToEntryID.put(28, 457);
        speciesToEntryID.put(29, 458);
        speciesToEntryID.put(30, 459);
        speciesToEntryID.put(31, 460);
        speciesToEntryID.put(32, 461);
        speciesToEntryID.put(33, 462);
        speciesToEntryID.put(34, 463);
        speciesToEntryID.put(35, 464);
        speciesToEntryID.put(36, 465);
        speciesToEntryID.put(37, 466);
        speciesToEntryID.put(38, 467);
        speciesToEntryID.put(39, 468);
        speciesToEntryID.put(40, 469);
        speciesToEntryID.put(41, 470);
        speciesToEntryID.put(42, 471);
        speciesToEntryID.put(43, 472);
        speciesToEntryID.put(44, 473);
        speciesToEntryID.put(45, 474);
        speciesToEntryID.put(46, 475);
        speciesToEntryID.put(47, 476);
        speciesToEntryID.put(48, 477);
        speciesToEntryID.put(49, 478);
        speciesToEntryID.put(50, 479);
        speciesToEntryID.put(51, 480);
        speciesToEntryID.put(52, 481);
        speciesToEntryID.put(53, 482);
        speciesToEntryID.put(54, 483);
        speciesToEntryID.put(55, 484);
        speciesToEntryID.put(56, 485);
        speciesToEntryID.put(57, 486);
        speciesToEntryID.put(58, 487);
        speciesToEntryID.put(59, 488);
        speciesToEntryID.put(60, 489);
        speciesToEntryID.put(61, 490);
        speciesToEntryID.put(62, 491);
        speciesToEntryID.put(63, 492);
        speciesToEntryID.put(64, 493);
        speciesToEntryID.put(65, 494);
        speciesToEntryID.put(66, 495);
        speciesToEntryID.put(67, 496);
        speciesToEntryID.put(68, 497);
        speciesToEntryID.put(69, 498);
        speciesToEntryID.put(70, 499);
        speciesToEntryID.put(71, 500);
        speciesToEntryID.put(72, 501);
        speciesToEntryID.put(73, 502);
        speciesToEntryID.put(74, 503);
        speciesToEntryID.put(75, 504);
        speciesToEntryID.put(76, 505);
        speciesToEntryID.put(77, 506);
        speciesToEntryID.put(78, 507);
        speciesToEntryID.put(79, 508);
        speciesToEntryID.put(80, 509);
        speciesToEntryID.put(81, 510);
        speciesToEntryID.put(82, 511);
        speciesToEntryID.put(83, 512);
        speciesToEntryID.put(84, 513);
        speciesToEntryID.put(85, 514);
        speciesToEntryID.put(86, 515);
        speciesToEntryID.put(87, 516);
        speciesToEntryID.put(88, 517);
        speciesToEntryID.put(89, 518);
        speciesToEntryID.put(90, 519);
        speciesToEntryID.put(91, 520);
        speciesToEntryID.put(92, 521);
        speciesToEntryID.put(93, 522);
        speciesToEntryID.put(94, 523);
        speciesToEntryID.put(95, 524);
        speciesToEntryID.put(96, 525);
        speciesToEntryID.put(97, 526);
        speciesToEntryID.put(98, 527);
        speciesToEntryID.put(99, 528);
        speciesToEntryID.put(100, 529);
        speciesToEntryID.put(101, 530);
        speciesToEntryID.put(102, 531);
        speciesToEntryID.put(103, 532);
        speciesToEntryID.put(104, 533);
        speciesToEntryID.put(105, 534);
        speciesToEntryID.put(106, 535);
        speciesToEntryID.put(107, 536);
        speciesToEntryID.put(108, 537);
        speciesToEntryID.put(109, 538);
        speciesToEntryID.put(110, 539);
        speciesToEntryID.put(111, 540);
        speciesToEntryID.put(112, 541);
        speciesToEntryID.put(113, 542);
        speciesToEntryID.put(114, 543);
        speciesToEntryID.put(115, 544);
        speciesToEntryID.put(116, 545);
        speciesToEntryID.put(117, 546);
        speciesToEntryID.put(118, 547);
        speciesToEntryID.put(119, 548);
        speciesToEntryID.put(120, 549);
        speciesToEntryID.put(121, 550);
        speciesToEntryID.put(122, 551);
        speciesToEntryID.put(123, 552);
        speciesToEntryID.put(124, 553);
        speciesToEntryID.put(125, 554);
        speciesToEntryID.put(126, 555);
        speciesToEntryID.put(127, 556);
        speciesToEntryID.put(128, 557);
        speciesToEntryID.put(129, 558);
        speciesToEntryID.put(130, 559);
        speciesToEntryID.put(131, 560);
        speciesToEntryID.put(132, 561);
        speciesToEntryID.put(133, 562);
        speciesToEntryID.put(134, 563);
        speciesToEntryID.put(135, 564);
        speciesToEntryID.put(136, 565);
        speciesToEntryID.put(137, 566);
        speciesToEntryID.put(138, 567);
        speciesToEntryID.put(139, 568);
        speciesToEntryID.put(140, 569);
        speciesToEntryID.put(141, 570);
        speciesToEntryID.put(142, 571);
        speciesToEntryID.put(143, 572);
        speciesToEntryID.put(144, 573);
        speciesToEntryID.put(145, 574);
        speciesToEntryID.put(146, 575);
        speciesToEntryID.put(147, 576);
        speciesToEntryID.put(148, 577);
        speciesToEntryID.put(149, 578);
        speciesToEntryID.put(150, 579);
        speciesToEntryID.put(151, 580);
        speciesToEntryID.put(152, 581);
        speciesToEntryID.put(153, 582);
        speciesToEntryID.put(154, 583);
        speciesToEntryID.put(155, 585);
        speciesToEntryID.put(156, 586);
        speciesToEntryID.put(157, 587);
        speciesToEntryID.put(158, 588);
        speciesToEntryID.put(159, 589);
        speciesToEntryID.put(160, 590);
        speciesToEntryID.put(161, 591);
        speciesToEntryID.put(162, 592);
        speciesToEntryID.put(163, 593);
        speciesToEntryID.put(164, 594);
        speciesToEntryID.put(165, 595);
        speciesToEntryID.put(166, 596);
        speciesToEntryID.put(167, 597);
        speciesToEntryID.put(168, 598);
        speciesToEntryID.put(169, 599);
        speciesToEntryID.put(170, 600);
        speciesToEntryID.put(171, 601);
        speciesToEntryID.put(172, 602);
        speciesToEntryID.put(173, 604);
        speciesToEntryID.put(174, 605);
        speciesToEntryID.put(175, 606);
        speciesToEntryID.put(176, 607);
        speciesToEntryID.put(177, 608);
        speciesToEntryID.put(178, 609);
        speciesToEntryID.put(179, 610);
        speciesToEntryID.put(180, 611);
        speciesToEntryID.put(181, 612);
        speciesToEntryID.put(182, 613);
        speciesToEntryID.put(183, 614);
        speciesToEntryID.put(184, 615);
        speciesToEntryID.put(185, 616);
        speciesToEntryID.put(186, 617);
        speciesToEntryID.put(187, 618);
        speciesToEntryID.put(188, 619);
        speciesToEntryID.put(189, 620);
        speciesToEntryID.put(190, 621);
        speciesToEntryID.put(191, 622);
        speciesToEntryID.put(192, 623);
        speciesToEntryID.put(193, 624);
        speciesToEntryID.put(194, 625);
        speciesToEntryID.put(195, 626);
        speciesToEntryID.put(196, 627);
        speciesToEntryID.put(197, 628);
        speciesToEntryID.put(198, 629);
        speciesToEntryID.put(199, 630);
        speciesToEntryID.put(200, 631);
        speciesToEntryID.put(201, 632);
        speciesToEntryID.put(202, 660);
        speciesToEntryID.put(203, 662);
        speciesToEntryID.put(204, 663);
        speciesToEntryID.put(205, 664);
        speciesToEntryID.put(206, 665);
        speciesToEntryID.put(207, 666);
        speciesToEntryID.put(208, 667);
        speciesToEntryID.put(209, 669);
        speciesToEntryID.put(210, 670);
        speciesToEntryID.put(211, 671);
        speciesToEntryID.put(212, 672);
        speciesToEntryID.put(213, 673);
        speciesToEntryID.put(214, 674);
        speciesToEntryID.put(215, 676);
        speciesToEntryID.put(216, 677);
        speciesToEntryID.put(217, 678);
        speciesToEntryID.put(218, 679);
        speciesToEntryID.put(219, 680);
        speciesToEntryID.put(220, 681);
        speciesToEntryID.put(221, 682);
        speciesToEntryID.put(222, 683);
        speciesToEntryID.put(223, 684);
        speciesToEntryID.put(224, 685);
        speciesToEntryID.put(225, 686);
        speciesToEntryID.put(226, 687);
        speciesToEntryID.put(227, 688);
        speciesToEntryID.put(228, 689);
        speciesToEntryID.put(229, 690);
        speciesToEntryID.put(230, 691);
        speciesToEntryID.put(231, 692);
        speciesToEntryID.put(232, 693);
        speciesToEntryID.put(233, 694);
        speciesToEntryID.put(234, 695);
        speciesToEntryID.put(235, 696);
        speciesToEntryID.put(236, 697);
        speciesToEntryID.put(237, 698);
        speciesToEntryID.put(238, 699);
        speciesToEntryID.put(239, 700);
        speciesToEntryID.put(240, 701);
        speciesToEntryID.put(241, 702);
        speciesToEntryID.put(242, 703);
        speciesToEntryID.put(243, 704);
        speciesToEntryID.put(244, 705);
        speciesToEntryID.put(245, 706);
        speciesToEntryID.put(246, 707);
        speciesToEntryID.put(247, 708);
        speciesToEntryID.put(248, 709);
        speciesToEntryID.put(249, 710);
        speciesToEntryID.put(250, 711);
        speciesToEntryID.put(251, 712);
        speciesToEntryID.put(252, 713);
        speciesToEntryID.put(253, 714);
        speciesToEntryID.put(254, 715);
        speciesToEntryID.put(255, 716);
        speciesToEntryID.put(256, 717);
        speciesToEntryID.put(257, 718);
        speciesToEntryID.put(258, 719);
        speciesToEntryID.put(259, 720);
        speciesToEntryID.put(260, 721);
        speciesToEntryID.put(261, 722);
        speciesToEntryID.put(262, 723);
        speciesToEntryID.put(263, 724);
        speciesToEntryID.put(264, 725);
        speciesToEntryID.put(265, 726);
        speciesToEntryID.put(266, 727);
        speciesToEntryID.put(267, 728);
        speciesToEntryID.put(268, 729);
        speciesToEntryID.put(269, 730);
        speciesToEntryID.put(270, 731);
        speciesToEntryID.put(271, 732);
        speciesToEntryID.put(272, 733);
        speciesToEntryID.put(273, 734);
        speciesToEntryID.put(274, 735);
        speciesToEntryID.put(275, 736);
        speciesToEntryID.put(276, 737);
        speciesToEntryID.put(277, 738);
        speciesToEntryID.put(278, 739);
        speciesToEntryID.put(279, 740);
        speciesToEntryID.put(280, 741);
        speciesToEntryID.put(281, 742);
        speciesToEntryID.put(282, 743);
        speciesToEntryID.put(283, 744);
        speciesToEntryID.put(284, 745);
        speciesToEntryID.put(285, 746);
        speciesToEntryID.put(286, 747);
        speciesToEntryID.put(287, 748);
        speciesToEntryID.put(288, 749);
        speciesToEntryID.put(289, 750);
        speciesToEntryID.put(290, 751);
        speciesToEntryID.put(291, 752);
        speciesToEntryID.put(292, 753);
        speciesToEntryID.put(293, 754);
        speciesToEntryID.put(294, 755);
        speciesToEntryID.put(295, 756);
        speciesToEntryID.put(296, 757);
        speciesToEntryID.put(297, 758);
        speciesToEntryID.put(298, 759);
        speciesToEntryID.put(299, 760);
        speciesToEntryID.put(300, 761);
        speciesToEntryID.put(301, 762);
        speciesToEntryID.put(302, 763);
        speciesToEntryID.put(303, 764);
        speciesToEntryID.put(304, 765);
        speciesToEntryID.put(305, 766);
        speciesToEntryID.put(306, 767);
        speciesToEntryID.put(307, 768);
        speciesToEntryID.put(308, 769);
        speciesToEntryID.put(309, 770);
        speciesToEntryID.put(310, 771);
        speciesToEntryID.put(311, 772);
        speciesToEntryID.put(312, 773);
        speciesToEntryID.put(313, 774);
        speciesToEntryID.put(314, 775);
        speciesToEntryID.put(315, 776);
        speciesToEntryID.put(316, 777);
        speciesToEntryID.put(317, 778);
        speciesToEntryID.put(318, 779);
        speciesToEntryID.put(319, 780);
        speciesToEntryID.put(320, 781);
        speciesToEntryID.put(321, 782);
        speciesToEntryID.put(322, 783);
        speciesToEntryID.put(323, 784);
        speciesToEntryID.put(324, 785);
        speciesToEntryID.put(325, 786);
        speciesToEntryID.put(326, 787);
        speciesToEntryID.put(327, 788);
        speciesToEntryID.put(328, 789);
        speciesToEntryID.put(329, 790);
        speciesToEntryID.put(330, 791);
        speciesToEntryID.put(331, 792);
        speciesToEntryID.put(332, 793);
        speciesToEntryID.put(333, 794);
        speciesToEntryID.put(334, 795);
        speciesToEntryID.put(335, 796);
        speciesToEntryID.put(336, 797);
        speciesToEntryID.put(337, 798);
        speciesToEntryID.put(338, 799);
        speciesToEntryID.put(339, 800);
        speciesToEntryID.put(340, 801);
        speciesToEntryID.put(341, 802);
        speciesToEntryID.put(342, 803);
        speciesToEntryID.put(343, 804);
        speciesToEntryID.put(344, 805);
        speciesToEntryID.put(345, 806);
        speciesToEntryID.put(346, 807);
        speciesToEntryID.put(347, 808);
        speciesToEntryID.put(348, 809);
        speciesToEntryID.put(349, 810);
        speciesToEntryID.put(350, 811);
        speciesToEntryID.put(351, 812);
        speciesToEntryID.put(352, 813);
        speciesToEntryID.put(353, 814);
        speciesToEntryID.put(354, 815);
        speciesToEntryID.put(355, 816);
        speciesToEntryID.put(356, 817);
        speciesToEntryID.put(357, 818);
        speciesToEntryID.put(358, 819);
        speciesToEntryID.put(359, 820);
        speciesToEntryID.put(360, 821);
        speciesToEntryID.put(361, 822);
        speciesToEntryID.put(362, 823);
        speciesToEntryID.put(363, 824);
        speciesToEntryID.put(364, 825);
        speciesToEntryID.put(365, 826);
        speciesToEntryID.put(366, 827);
        speciesToEntryID.put(367, 828);
        speciesToEntryID.put(368, 829);
        speciesToEntryID.put(369, 830);
        speciesToEntryID.put(370, 831);
        speciesToEntryID.put(371, 832);
        speciesToEntryID.put(372, 833);
        speciesToEntryID.put(373, 834);
        speciesToEntryID.put(374, 835);
        speciesToEntryID.put(375, 836);
        speciesToEntryID.put(376, 837);
        speciesToEntryID.put(377, 838);
        speciesToEntryID.put(378, 839);
        speciesToEntryID.put(379, 840);
        speciesToEntryID.put(380, 841);
        speciesToEntryID.put(381, 842);
        speciesToEntryID.put(382, 843);
        speciesToEntryID.put(383, 844);
        speciesToEntryID.put(384, 845);
        speciesToEntryID.put(385, 846);
        speciesToEntryID.put(386, 847);
        speciesToEntryID.put(387, 851);
        speciesToEntryID.put(388, 852);
        speciesToEntryID.put(389, 853);
        speciesToEntryID.put(390, 854);
        speciesToEntryID.put(391, 855);
        speciesToEntryID.put(392, 856);
        speciesToEntryID.put(393, 857);
        speciesToEntryID.put(394, 858);
        speciesToEntryID.put(395, 859);
        speciesToEntryID.put(396, 860);
        speciesToEntryID.put(397, 861);
        speciesToEntryID.put(398, 862);
        speciesToEntryID.put(399, 863);
        speciesToEntryID.put(400, 864);
        speciesToEntryID.put(401, 865);
        speciesToEntryID.put(402, 866);
        speciesToEntryID.put(403, 867);
        speciesToEntryID.put(404, 868);
        speciesToEntryID.put(405, 869);
        speciesToEntryID.put(406, 870);
        speciesToEntryID.put(407, 871);
        speciesToEntryID.put(408, 872);
        speciesToEntryID.put(409, 873);
        speciesToEntryID.put(410, 874);
        speciesToEntryID.put(411, 875);
        speciesToEntryID.put(412, 876);
        speciesToEntryID.put(413, 879);
        speciesToEntryID.put(414, 882);
        speciesToEntryID.put(415, 883);
        speciesToEntryID.put(416, 885);
        speciesToEntryID.put(417, 886);
        speciesToEntryID.put(418, 887);
        speciesToEntryID.put(419, 888);
        speciesToEntryID.put(420, 889);
        speciesToEntryID.put(421, 890);
        speciesToEntryID.put(422, 891);
        speciesToEntryID.put(423, 893);
        speciesToEntryID.put(424, 895);
        speciesToEntryID.put(425, 896);
        speciesToEntryID.put(426, 897);
        speciesToEntryID.put(427, 898);
        speciesToEntryID.put(428, 899);
        speciesToEntryID.put(429, 900);
        speciesToEntryID.put(430, 901);
        speciesToEntryID.put(431, 902);
        speciesToEntryID.put(432, 903);
        speciesToEntryID.put(433, 904);
        speciesToEntryID.put(434, 905);
        speciesToEntryID.put(435, 906);
        speciesToEntryID.put(436, 907);
        speciesToEntryID.put(437, 908);
        speciesToEntryID.put(438, 909);
        speciesToEntryID.put(439, 910);
        speciesToEntryID.put(440, 911);
        speciesToEntryID.put(441, 912);
        speciesToEntryID.put(442, 913);
        speciesToEntryID.put(443, 914);
        speciesToEntryID.put(444, 916);
        speciesToEntryID.put(445, 918);
        speciesToEntryID.put(446, 920);
        speciesToEntryID.put(447, 921);
        speciesToEntryID.put(448, 922);
        speciesToEntryID.put(449, 923);
        speciesToEntryID.put(450, 925);
        speciesToEntryID.put(451, 927);
        speciesToEntryID.put(452, 928);
        speciesToEntryID.put(453, 929);
        speciesToEntryID.put(454, 930);
        speciesToEntryID.put(455, 931);
        speciesToEntryID.put(456, 932);
        speciesToEntryID.put(457, 933);
        speciesToEntryID.put(458, 934);
        speciesToEntryID.put(459, 935);
        speciesToEntryID.put(460, 936);
        speciesToEntryID.put(461, 937);
        speciesToEntryID.put(462, 938);
        speciesToEntryID.put(463, 939);
        speciesToEntryID.put(464, 940);
        speciesToEntryID.put(465, 941);
        speciesToEntryID.put(466, 942);
        speciesToEntryID.put(467, 943);
        speciesToEntryID.put(468, 944);
        speciesToEntryID.put(469, 945);
        speciesToEntryID.put(470, 946);
        speciesToEntryID.put(471, 947);
        speciesToEntryID.put(472, 948);
        speciesToEntryID.put(473, 949);
        speciesToEntryID.put(474, 950);
        speciesToEntryID.put(475, 951);
        speciesToEntryID.put(476, 952);
        speciesToEntryID.put(477, 953);
        speciesToEntryID.put(478, 954);
        speciesToEntryID.put(479, 955);
        speciesToEntryID.put(480, 961);
        speciesToEntryID.put(481, 962);
        speciesToEntryID.put(482, 963);
        speciesToEntryID.put(483, 964);
        speciesToEntryID.put(484, 965);
        speciesToEntryID.put(485, 966);
        speciesToEntryID.put(486, 967);
        speciesToEntryID.put(487, 968);
        speciesToEntryID.put(488, 970);
        speciesToEntryID.put(489, 971);
        speciesToEntryID.put(490, 972);
        speciesToEntryID.put(491, 973);
        speciesToEntryID.put(492, 974);
        speciesToEntryID.put(493, 976);
        // Return -1 if no mapping exists (keeps original sprite)
        return speciesToEntryID.getOrDefault(speciesNumber, -1);
    }
    ...
    public boolean setStaticPokemon(List<StaticEncounter> staticPokemon) {
        ...
        try {
            ...
            NARCArchive scriptNARC = scriptNarc;
            NARCArchive eventNARC = eventNarc;
            for (StaticPokemon statP : romEntry.staticPokemon) {
                ...
                // Update overworld sprite if Event data exists
                if (statP.eventFile != -1 && statP.eventEntryIDOffset != -1) {
                    int newEntryID = getPokemonOverworldEntryID(se.pkmn.number);
                    if (newEntryID != -1) {
                        byte[] eventFile = eventNARC.files.get(statP.eventFile);
                        writeWord(eventFile, statP.eventEntryIDOffset, newEntryID);
                    }
                }
            }
            if (romEntry.arrayEntries.containsKey("StaticPokemonTrades")) {
