...
//                    townAMX.getBytes());
    ...
    private void loadBasicPokeStats(Pokemon pkmn, byte[] stats, Map<Integer,FormeInfo> altFormes) {
        ...
        // NOT add the base form. For example, if we are currently looking at Pikachu, it will add Pikachu with various
        // hats to the list of realCosmeticFormNumbers, but it will not add hatless Pikachu. Without any corrections,
        // this will make base Pikachu impossible to randomly select. The simplest way to fix this is to just add
