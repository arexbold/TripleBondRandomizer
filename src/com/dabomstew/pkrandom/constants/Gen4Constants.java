...
public class Gen4Constants {
    ...
    public static final List<Integer> uselessAbilities = Arrays.asList(Abilities.forecast, Abilities.multitype, Abilities.flowerGift, Abilities.illuminate);
    ...
    private static void setupAllowedItems() {
        ...
        nonBadItems.banSingles(Items.oddKeystone, Items.griseousOrb, Items.soulDew, Items.lightBall,
                ...
                Items.shedShell, Items.luckyPunch, Items.metalPowder, Items.bigRoot, Items.toxicOrb);
